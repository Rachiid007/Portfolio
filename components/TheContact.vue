...
<template>
  <article id="contact" ref="contactContent">
    <h2 class="title" ref="contactPos">{{ $t('contact.title') }}</h2>
      ...
      <section class="column left" role="region">
        ...
        <div id="contact-infos">
          ...
          <div class="row">
            ...
            <div class="sub-title">
              <NuxtLink to="tel:+32484818944">+32 484 818 944</NuxtLink>
            </div>
          </div>

          <div class="row" id="icons-social-network">
            <NuxtLink to="https://www.linkedin.com/in/abderrachid-bellaali-753471145" target="_blank">
              <i class="fa-brands fa-linkedin fa-2xl"></i>
            </NuxtLink>
            <NuxtLink to="https://github.com/Rachiid007" target="_blank">
              <i class="fa-brands fa-github fa-2xl"></i>
            </NuxtLink>
            <NuxtLink to="https://twitter.com/Rachiid007" target="_blank">
